...
export function InvestorHero() {
  ...
  return (
    <>
      <section className="page-x flex min-h-svh flex-col border-b border-text-primary/10 bg-background">
        <div
          className="mx-auto flex w-full max-w-[1200px] flex-1 flex-col pb-10 md:pb-14"
          style={{ paddingTop: NAV_BAR_HEIGHT_PX }}
        >
          <div className="grid flex-1 grid-cols-12 content-center gap-x-6 gap-y-10 md:gap-x-8 md:gap-y-12">
            ...
            <div className="col-span-12 md:col-start-7 md:col-span-6 lg:col-start-6 lg:col-span-7">
              <div className="relative aspect-4/3 w-full border border-text-primary/12 bg-text-primary/4 md:aspect-video">
                <Image
                  src={image.src}
                  alt={image.alt}
                  fill
          ...
          <FadeIn className="mt-auto pt-10 md:pt-14">
